                      ...
                      {isUserMenuOpen && (
                        ...
                        >
                          ...
                          <div className="py-1">
                            ...
                            <button onClick={() => { handleNav(View.Admin); setIsUserMenuOpen(false); }} className="w-full text-left flex items-center px-4 py-2 text-sm text-purple-300 hover:bg-purple-500/20">
